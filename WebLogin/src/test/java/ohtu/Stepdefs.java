...
public class Stepdefs {
    ...
    @When("^When correct username \"([^\"]*)\" and password \"([^\"]*)\" are given$")
    public void when_correct_username_and_password_are_given(String username, String password) throws Throwable {
    ...
    @When("^a invalid username \"([^\"]*)\" and valid password \"([^\"]*)\" are entered$")
    public void a_invalid_username_and_valid_password_are_entered(String username, String password) throws Throwable {
        WebElement element = driver.findElement(By.name("username"));
        element.sendKeys(username);
        element = driver.findElement(By.name("password"));
        element.sendKeys(password);
    ...
    @Then("^Then user is not logged in and error \"([^\"]*)\" is given$")
    public void then_user_is_not_logged_in_and_error_is_given(String arg1) throws Throwable {
        pageHasContent("invalid username or password");
    }
